...
class Pay extends React.Component {
    ...
    createHandler = () => {
        //Check form validity
        if(!(this.state.ctx && this.state.issuer && this.state.accountNumber && this.state.checkNumber && this.state.checkStatus && this.state.checkPaidDate && this.state.checkAmount && this.state.newOwner)){
    ...
    render () {
        ...
        return (
            ...
            <TextField
                ...
                className={classes.textField}
                value={this.state.name}
                onChange={this.handleChange('checkPaidDate')}
                margin="normal"
            />
            <TextField
                label='Amount'
